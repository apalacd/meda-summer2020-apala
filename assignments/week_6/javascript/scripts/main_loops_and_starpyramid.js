/* Objective : Display the following pyramid
...
// the double plus operator will take the current value of the variable and add a 1 to it and also replace that old value of the variable.
// myVariable++;
